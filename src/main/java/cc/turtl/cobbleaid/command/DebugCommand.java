...
public class DebugCommand {
    ...
    private static int executeHelp(CommandContext<FabricClientCommandSource> context) {
        ...
        CommandUtils.sendUsageWithDescription(source, "/" + CobbleAid.MODID + " debug dump <slot>",
                "Dumps info about provided slot.");
        CommandUtils.sendUsageWithDescription(source, "/" + CobbleAid.MODID + " debug dump look",
