package cc.turtl.cobbleaid.api.comparator;
...
public final class PokemonComparators {
    ...
    public static final Comparator<Pokemon> IVS_COMPARATOR = 
        Comparator.nullsLast(Comparator.comparingInt(p -> p.getIvs().getEffectiveBattleTotal()));
}